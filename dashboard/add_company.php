                        ...
                        <div class="col-md-12 col-xs-12">                            
                            <div class=" col-md-12 col-xs-12 pnl-header"style="padding: 15px;">
                                <div class="col-md-2 col-xs-12 title-wraper">
                                    <h3 style="margin-top: 5px"> Company </h3> 
                                </div>
                                <div class="col-md-3 col-xs-12 pull-right">
                                    <button class="btn common-btn" id="creat-voucher" data-toggle="modal" data-target="#squarespaceModal">Add Company</button>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-lg-offset-2 col-md-offset-2">
                                      <?php 
                                        if(isset($_POST['add_company_submit'])){
                                                ...
                                                $result = $Pmethod->company_insert($db,$company);
                                                if($result){ ?>
                                    ...
                                    <div class="col-md-5 col-xs-12 value-table">
                                        <table class="table table-striped table-bordered table-responsive">
                                            ...
                                            <tbody>
                                                <?php 
                                                  $i=1;
                                                  $select = $Pmethod->company_View($db);
                                                ...
                                                <tr>
                                                    ...
                                                    <!-- <td><a href="">Edit</a></td> -->
                                                    <td><a href="../model/delete.php?company_nameDelete=<?php echo $fetch['company_id']; ?>">Delete</a></td>
                                                </tr>
                                                 <?php } ?>
                                            </tbody>
                                        </table>
                                             ...
                                             <form action="" method="post">
                                                <div class="modal-content"style="width: 800px">
                                                    <div class="modal-header">
                                                        ...
                                                        <h3 class="modal-title" id="lineModalLabel">Add New Company</h3>
                                                    </div>
                                                    <div class="modal-body">
                                                        <h3 class="modal-title" id="lineModalLabel"style="text-align: left;font-size: 20px;"> <i class="fa fa-warning" style="color: wheat"></i> Company Information </h3>
                                                        <!-- content goes here -->
                                                        <form>
                                                            <div class="form-group"style="padding: 30px 0px 30px 0; margin: 0">
                                                                ...
                                                                <div class="col-md-7 padding" style="padding: 0px;">
                                                                    <input type="text" name="company" class="form-control" placeholder="Location name"> 
                                                                </div>
                                                                <div class="col-md-1 padding">
                                                                   <input type="submit" name="add_company_submit" value="Submit" class="btn btn-md btn-primary pull-left">
                                                                </div>
